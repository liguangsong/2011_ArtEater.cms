<template>
    <div class="container-wrap">
        <Form ref="form" :model="form" label-position="right" :label-width="150" :rules="ruleValidate">
            <div style="width:1050px">
                <div class="formItem">
                    <FormItem label="每次签到得" prop="signUpScore">
                        <div class="inputDiv">
                            <div class="input">
                                <Input type="number" v-model="form.signUpScore" placeholder="请输入积分"></Input>
                            </div>
                            <div class="comment">
                                <label>积分</label>
                            </div>
                ...
                <div class="formItem">
                    <FormItem label="积分兑换人民币比例" prop="scoreMoneyPercent">
                        <div class="inputDiv">
                            <div class="input">
                                <Input type="number" v-model="form.scoreMoneyPercent" placeholder="请输入积分"></Input>
                            </div>
                            <div class="comment">
                                <label>:1</label>
                            </div>
                ...
                <div class="formItem">
                    <FormItem label="正确率高" prop="percentH">
                        <div class="inputDiv">
                            <div class="input">
                                <Input type="number" v-model="form.percentH" placeholder="请输入比例"></Input>
                            </div>
                            <div class="comment">
                                <label>%</label>
                            </div>
                ...
                <div class="formItem">
                    <FormItem label="第一次答题得" prop="firstExamScore">
                        <div class="inputDiv">
                            <div class="input">
                                <Input type="number" v-model="form.firstExamScore" placeholder="请输入积分"></Input>
                            </div>
                            <div class="comment">
                                <label>积分</label>
                            </div>
                ...
                <div class="formItem">
                    <FormItem label="正确率中" prop="percentM">
                        <div class="inputDiv">
                            <div class="input">
                                <Input type="number" v-model="form.percentM" placeholder="请输入比例"></Input>
                            </div>
                            <div class="comment">
                                <label>%</label>
                            </div>
                ...
                <div class="formItem">
                    <FormItem label="第二次到多次答题得" prop="secondExamScore">
                        <div class="inputDiv">
                            <div class="input">
                                <Input type="number" v-model="form.secondExamScore" placeholder="请输入积分"></Input>
                            </div>
                            <div class="comment">
                                <label>积分</label>
                            </div>
                ...
                <div class="formItem">
                    <FormItem label="分享拉新得" prop="shareScore">
                        <div class="inputDiv">
                            <div class="input">
                                <Input type="number" v-model="form.shareScore" placeholder="请输入积分"></Input>
                            </div>
                            <div class="comment">
                                <label>积分</label>
                            </div>
                ...
                <div class="formItem">
                    <FormItem label="每元花费得" prop="shopScore">
                        <div class="inputDiv">
                            <div class="input">
                                <Input type="number" v-model="form.shopScore" placeholder="请输入积分"></Input>
                            </div>
                            <div class="comment">
                                <label>积分</label>
                            </div>
                ...
                <div class="formItem" style="width:700px">
                    <FormItem label="版权说明">
                        <div class="inputDiv">
                            <div class="input">
                                 <Input v-model="form.version" :maxlength="50"  :show-word-limit="true" type="textarea" placeholder="请输入版权说明"></Input>
                            </div>
                            <div class="comment">
                            </div>
                        </div>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            ruleValidate: {
                signUpScore: [{ required: true, message: '请输入正确的积分', trigger: 'blur',validator:verification.validateInt }],
                firstExamScore: [{ required: true, message: '请输入正确的积分', trigger: 'blur',validator:verification.validateInt }],
                secondExamScore: [{ required: true, message: '请输入正确的积分', trigger: 'blur',validator:verification.validateInt }],
                shareScore: [{ required: true, message: '请输入正确的积分', trigger: 'blur',validator:verification.validateInt }],
                shopScore: [{ required: true, message: '请输入正确的积分', trigger: 'blur',validator:verification.validateInt }],
                scoreMoneyPercent: [{ required: true, message: '请输入正确的积分', trigger: 'blur',validator:verification.validateInt }],
                allErrorPercent: [{ required: true, message: '请输入最多包含两位小数的比例', trigger: 'blur',validator:verification.validateFloat2 }],
                percentH: [{ required: true, message: '请输入最多包含两位小数的比例', trigger: 'blur',validator:verification.validateFloat2 }],
                percentM: [{ required: true, message: '请输入最多包含两位小数的比例', trigger: 'blur',validator:verification.validateFloat2 }],
