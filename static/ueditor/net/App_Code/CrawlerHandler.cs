...
public class CrawlerHandler : Handler
{
    ...
    public override void Process()
    {
        ...
        string basePath = Context.Request.Url.Scheme + "://" + Context.Request.Url.Authority + Context.Request.ApplicationPath;
        // Crawlers[0].Server._context.Request.Url.Authority
        WriteJson(new
        {
            state = "SUCCESS",
            list = Crawlers.Select(x => new
            {
                state = x.State,
                source = x.SourceUrl,
                url = basePath + x.ClientUrl + x.ServerUrl
            })
        });
    }
}
...
public class Crawler
{
    ...
    public Crawler Fetch()
    {
        ...
        using (var response = request.GetResponse() as HttpWebResponse)
        {
            ...
            ClientUrl = Config.GetString("catcherUrlPrefix");
